          ...
          child: SafeArea(
            child: ListView(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    '${lockedApps.length} تطبيق مقفل الآن',
                    ...
                    child: KaddCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'بدونها ما يقدرش يعرف أي تطبيق مفتوح حاليًا. فعّل الصلاحية من إعدادات النظام ورجع للتطبيق.',
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              nextPrayer == null
                                  ? 'مواقيت الصلاة'
                                  : 'الصلاة القادمة: ${nextPrayer.name.labelAr}',
                    ...
                    child: KaddCard(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            'ما قفلتي حتى تطبيق — اضغط باش تبدأ',
                            style: AppTextStyles.body(size: 12.5, color: AppColors.unlock),
                          ),
                        ],
                      ),
                    ),
