                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('${app.repsFor(state.difficulty)} ضغطة = ${app.minutesGranted} د',
                    ...
                    child: KaddCard(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('ما قفلتي حتى تطبيق — اضغط باش تبدأ', style: AppTextStyles.body(size: 12.5, color: AppColors.unlock)),
                        ],
                      ),
                    ),
                  ),
